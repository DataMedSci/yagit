...
#include <math/grid_search/basic/openmp/gamma_index_range_impl.hpp>
...
namespace yagit::core::math
{
	...
	{
		if (auto ec = grid_search::basic::openmp::detail::gamma_index_initialize_pass(gamma_index_output, gamma_index_output_end))
			return ec;
		if (auto ec = grid_search::basic::openmp::detail::gamma_index_minimize_pass(
			...
			return ec;
		if (auto ec = grid_search::basic::openmp::detail::gamma_index_finalize_pass(gamma_index_output, gamma_index_output_end))
			return ec;
		return {};
	}
}