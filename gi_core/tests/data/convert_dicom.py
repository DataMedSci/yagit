...
def load_dcm_image(filename):
    ...
    if scaling is not None:
        ...
        scaling = dcmimage.get(0x00281053)
        intercept = dcmimage.get(0x00281052)
        if scaling is not None and intercept is not None:
            numpyImage = numpyImage * scaling.value + intercept.value
