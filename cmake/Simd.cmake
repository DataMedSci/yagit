function(add_simd_flags target extension)
    if(MSVC)
        ...
        elseif(extension STREQUAL "AVX" OR extension STREQUAL "AVX_FMA")
            target_compile_options(${target} PRIVATE /arch:AVX)
        elseif(extension STREQUAL "AVX2" OR extension STREQUAL "AVX2_FMA")
        ...
        elseif(extension STREQUAL "AVX_FMA")
            target_compile_options(${target} PRIVATE -mavx -mfma)
        elseif(extension STREQUAL "AVX2")
            target_compile_options(${target} PRIVATE -mavx2)
        elseif(extension STREQUAL "AVX2_FMA")
